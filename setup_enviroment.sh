...
if [ "$OS_TYPE" = "macOS" ]; then
    echo "1. **IMPORTANT FOR MACOS:**"
    echo "   - Ensure Docker Desktop is running from your Applications folder"
    echo "   - You may need to grant permissions in System Preferences > Security & Privacy"
    echo ""
fi
echo "2. If you haven't already, run './copy_script.sh' to link agents to Roo."
echo ""
echo "3. **IMPORTANT FOR VS CODE:** To make the Roo extension work correctly,"
